    ...
    <nav className="fixed top-0 left-0 z-30 w-full border-b border-white/50 bg-white/70 backdrop-blur-xl">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 lg:px-10">
        ...
        <ul className="hidden items-center gap-6 text-sm font-medium text-slate-700 md:flex">
          <li><Link to="/" className="transition hover:text-emerald-900">About</Link></li>
          <li><Link to="/rooms" className="transition hover:text-emerald-900">Rooms</Link></li>
          <li><Link to="/dining" className="transition hover:text-emerald-900">Dining</Link></li>
          <li><Link to="/gallery" className="transition hover:text-emerald-900">Gallery</Link></li>
          <li><Link to="/contact" className="transition hover:text-emerald-900">Contact</Link></li>
        </ul>
